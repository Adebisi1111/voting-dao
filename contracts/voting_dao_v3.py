...
class VoterRecord:
    ...
    vote_count: u256  # NEW: track total votes cast
...
class VotingDAO(gl.Contract):
    ...
    def register_voter(self) -> None:
        ...
        if rec is None:
            rec = VoterRecord(registered=True, last_proposal_voted="", vote_count=u256(0))
        else:
            rec.registered = True
    ...
    def cast_vote(self, proposal_id: str, vote: str) -> None:
        ...
        rec.vote_count += u256(1)  # NEW: increment vote count
        self.voters[sender] = rec
        self.proposals[proposal_id] = proposal
