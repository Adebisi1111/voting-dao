// Script to seed VotingDAO with realistic testnet data
// Run with: node seed_data.mjs

import { createClient, chains } from 'genlayer-js';

const CONTRACT = '0x20f8d6cB56f922C973b9A7D7479E9452A61217BE';

// Use the default account from genlayer config
...
async function main() {
  ...
  for (const v of votes) {
    try {
      ...
      console.log(`   Error on ${v.proposal}: ${e.message?.slice(0, 100)}`);
    }
  }
